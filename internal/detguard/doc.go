...
// constructor, no math package import, no bare float32/float64 type
// name and no float-valued decimal accessor at every route this
// package's AST walk reaches, and no map ranging as far as a
// name-based scan can see one. It composes
