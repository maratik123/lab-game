...
func TestCeiling_formula(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			// 1 * Binaries(9) * 1 * (schemaMaxConns(4)+1) + ceilingSlack(32) = 77,
		...
		},
		{
			...
			// 2 * 9 * 3 * 5 + 32 = 302, above the floor.
		...
		},
		{
			...
			// 2 * 9 * 16 * 5 + 32 = 1472, above the floor and below the raised
		...
		},
		{
			...
			// 10 * 9 * 10 * 5 + 32 = 4532, above ceilingMax(2000).
