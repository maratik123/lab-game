...
func TestDerive_perRow(t *testing.T) {
	...
	cases := []struct {
		...
		{"business_connection", func() *telego.Update { return &telego.Update{BusinessConnection: &telego.BusinessConnection{}} }, KindBusinessConnection, false, false},
		...
		{"deleted_business_messages", func() *telego.Update {
			return &telego.Update{DeletedBusinessMessages: &telego.BusinessMessagesDeleted{}}
		}, KindDeletedBusinessMessages, false, false},
		{"guest_message", func() *telego.Update { return &telego.Update{GuestMessage: msg()} }, KindGuestMessage, true, true},
		{"message_reaction", func() *telego.Update { return &telego.Update{MessageReaction: &telego.MessageReactionUpdated{}} }, KindMessageReaction, false, false},
		{"message_reaction_count", func() *telego.Update {
			return &telego.Update{MessageReactionCount: &telego.MessageReactionCountUpdated{}}
		}, KindMessageReactionCount, false, false},
		...
		{"chat_join_request", func() *telego.Update { return &telego.Update{ChatJoinRequest: &telego.ChatJoinRequest{}} }, KindChatJoinRequest, false, false},
		{"chat_boost", func() *telego.Update { return &telego.Update{ChatBoost: &telego.ChatBoostUpdated{}} }, KindChatBoost, false, false},
		{"removed_chat_boost", func() *telego.Update { return &telego.Update{RemovedChatBoost: &telego.ChatBoostRemoved{}} }, KindRemovedChatBoost, false, false},
