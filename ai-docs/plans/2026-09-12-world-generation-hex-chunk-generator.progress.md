...
**last_passed_gate:** `go build ./... && go test ./... && go vet ./... && golangci-lint run && go test -race ./...` (internal/maze Generator/New/Cell/prefab) | 2026-09-13
**entry_args:** 27
...
- [ ] 9. The property suite, the cell golden with its per-algorithm sections, this package's `guards_test.go`  ← CURRENT
