...
**last_passed_gate:** `go build ./... && go test ./... && go vet ./... && golangci-lint run && go test -race ./...` (internal/maze chunkgraph + island) | 2026-09-13
**entry_args:** 27
...
- [ ] 6. The five algorithms over the non-island induced subgraph — backtracker, Kruskal, frontier Prim, growing tree, Wilson  ← CURRENT
