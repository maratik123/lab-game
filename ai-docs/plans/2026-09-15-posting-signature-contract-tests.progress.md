...
**current_step:** Step 8 — subtask 5 of 6 complete
**last_passed_gate:** go build ./...; go vet ./...; golangci-lint fmt -d; golangci-lint run (whole module); go test ./internal/contract/... (incl. -race); make comment-refs; make import-guard; both check.go-level design-named mutants confirmed red then reverted
**entry_args:** 26
...
- [ ] 6. The declared set, then close the group with the whole-module gates (D8, D10)  ← CURRENT
