...
**last_passed_gate:** go build ./...; go vet ./...; golangci-lint fmt -d; golangci-lint run (whole module); go test ./internal/contract/...; make comment-refs; make import-guard; all 3 design-named mutants confirmed red then reverted
**entry_args:** 26
...
- [ ] 5. The contract check against real transactions (D6, D11)  ← CURRENT
