...
**current_step:** Step 8 — subtask 8 of 10 complete
**last_passed_gate:** golangci-lint run | 2026-09-05T15:05:00Z | (pending commit)
**entry_args:** 20

## Next action

**Do this immediately:** continue Group A at subtask 9 — the per-task execution deadline and the settlement of everything it abandons (`settle.go`).
...
- [ ] 9. The per-task deadline and the settlement of everything it abandons (`settle.go`)  ← CURRENT
