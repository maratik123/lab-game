...
**current_step:** Step 8 — subtask 4 of 10 complete
**last_passed_gate:** golangci-lint run | 2026-09-05T14:45:00Z | (pending commit)
**entry_args:** 20

## Next action

**Do this immediately:** continue Group A at subtask 5 — the insertion surface `(*Registry).Schedule` and `DeadTasks`.
...
- [ ] 5. The insertion surface: `(*Registry).Schedule`  ← CURRENT
