...
**last_passed_gate:** golangci-lint run ./internal/testdb/...
**entry_args:** 74
...
- [ ] 4. Rollout — every package with tests declares `TestMain` in the D2 form; the whole suite on every route  ← CURRENT
