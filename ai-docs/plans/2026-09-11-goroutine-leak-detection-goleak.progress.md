...
**last_passed_gate:** go build ./... | 2026-09-11T16:33:24Z | 364657b
**entry_args:** 74
...
- [ ] 1. `internal/tgtest` — D8 fix, its tests (T1), and the `internal/tg/retry_test.go` doc-comment rewrite  ← CURRENT
- [ ] 2. `internal/leaktest` — `Main`, `Ignore`, the check, T2's unit tests, the package's own `TestMain`
