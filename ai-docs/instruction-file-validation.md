...
```
You are a comprehension-test subagent for the lab-game project's <FILE>
...
```
You are a semantic-preservation review subagent for the lab-game project's
...
```
You are running as the review-findings agent on a lab-game codebase review.
...
lab-game is a fresh repo with no replay history yet; the shape below is
...
Once lab-game accumulates a correction history, target rules with the
